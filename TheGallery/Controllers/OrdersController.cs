...
namespace TheGallery.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(TheGalleryContext context)
        {
            _context = context;
        }
        ...
        {
            var theGalleryContext = _context.Order.Include(o => o.Cart);
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Address,TotalPrice,CartId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
